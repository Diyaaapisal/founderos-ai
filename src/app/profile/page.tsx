...
import { Cpu, ArrowLeft, User, Mail, Shield, Award, Activity } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#030712] relative flex flex-col justify-between py-12 px-6">
      ...
      <main className="max-w-3xl mx-auto w-full px-6 py-4 relative z-10 flex-grow space-y-8">
        ...
        <div className="flex items-center gap-4">
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-cyan-500 to-emerald-450 flex items-center justify-center shadow-lg shadow-cyan-500/10 text-black">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 mt-1">Sovereign ledger node administrator details.</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="glass-panel p-6 rounded-2xl space-y-4 md:col-span-2">
            <h3 className="heading-font font-bold text-white text-sm border-b border-white/5 pb-2 flex items-center gap-1.5"><Shield className="w-4 h-4 text-cyan-400" /> Administrative Credentials</h3>
            ...
            <div className="space-y-4 text-xs">
              ...
              <div>
                <span className="text-[10px] text-gray-500 font-mono uppercase block">Linked Email Address</span>
                <span className="text-white font-semibold mt-0.5 block flex items-center gap-1"><Mail className="w-3.5 h-3.5 text-gray-500" /> administrator@founderos.ai</span>
              </div>

              <div>
                <span className="text-[10px] text-gray-500 font-mono uppercase block">Subscription status</span>
                <span className="text-cyan-455 text-cyan-400 font-semibold mt-0.5 block uppercase flex items-center gap-1.5 font-mono text-[10px]">
                  <Award className="w-4 h-4 animate-bounce" /> {plan === "premium" ? "Venture Scale Tier Active" : "Developer Sandbox Tier"}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="glass-panel p-6 rounded-2xl space-y-4 flex flex-col justify-between">
            <div className="space-y-3">
              <h3 className="heading-font font-bold text-white text-sm border-b border-white/5 pb-2 flex items-center gap-1.5"><Activity className="w-4 h-4 text-emerald-400 animate-pulse" /> Compute Allocations</h3>
              
              <div className="space-y-2 text-[11px] font-mono text-gray-400">
                <div className="flex justify-between">
                  <span>API Tokens Used:</span>
                  <span className="text-white font-semibold">4,120 / 50k</span>
                </div>
                <div className="w-full bg-white/5 h-1 rounded-full overflow-hidden">
                  <div className="bg-cyan-500 h-full rounded-full" style={{ width: "10%" }}></div>
                </div>

                <div className="flex justify-between pt-1">
                  <span>Receipt Scans:</span>
                  <span className="text-white font-semibold">{plan === "premium" ? "Unlimited" : "4 / 10"}</span>
                </div>
                <div className="w-full bg-white/5 h-1 rounded-full overflow-hidden">
                  <div className="bg-emerald-500 h-full rounded-full" style={{ width: plan === "premium" ? "100%" : "40%" }}></div>
                </div>
              </div>
            </div>
